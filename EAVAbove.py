...
class EAVAboveCalc(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        verifyLibs()
        runEAVAbove(basinSource,demLayer,pathData,pathGraph,distanceCurves,baseLevel,useOnlyRasterElev,useMinRasterElev,feedback,decimalPlaces,useAllDecimalPlaces)
