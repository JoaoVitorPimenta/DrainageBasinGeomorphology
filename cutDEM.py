...
from .algorithms.cutDEMProcessing import calcCuttedForParameter, verifyLibs

class cuttedCalc(QgsProcessingAlgorithm):
    '''
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        cuttedDEMFolder = self.parameterAsString(parameters, self.CUTTED_DEM, context)

        modifiedVectorArea = self.parameterAsString(parameters, self.MODIFIED_AREA, context)

        verifyLibs()
        calcCuttedForParameter(basinSource,demLayer,selectedParameter,parameterValue,cuttedDEMFolder,modifiedVectorArea,noDataValue,openRasters,openVectors,feedback)
        ...
        # or output names.
        return {self.CUTTED_DEM: cuttedDEMFolder,
                self.MODIFIED_AREA: modifiedVectorArea}
    ...
    def shortHelpString(self):
        ...
        <strong>Parameter: </strong>It is the parameter of the EAV (above) curve to be used to calculate the inundated area.
        ...
        <strong>Cutted DEM: </strong>Path to the folder containing the cutted area rasters.
        <strong>Modified area: </strong>Path to the folder containing the cutted area vectors, in the vector attribute table there is the height, elevation, area and volume value.     
