...
from qgis.core import (QgsProcessing,
                       ...
                       QgsField)
from .algorithms.priorizationMorphCalc import calcMorphPriority,verifyLibs

class morphometricAnalysisMorphometric(QgsProcessingAlgorithm):
    '''
    ...
    def initAlgorithm(self, config):
        ...
        self.addParameter(
            QgsProcessingParameterEnum(
                ...
                description='Parameters for morphometric analysis (directly proportional)',
        ...
        self.addParameter(
            QgsProcessingParameterEnum(
                ...
                description='Parameters for morphometric analysis (inversely proportional)',
                options=self.parametersToChoose,
                allowMultiple=True,
                defaultValue=[],
            )
        ...
        self.addParameter(
            QgsProcessingParameterFeatureSink(
                self.BASINS_RANKED,
                self.tr('Ranked basins morphometric'))
            )
    ...
    def name(self):
        ...
        '''
        return 'Calculate basin priority (Morphometric)'
    ...
    def createInstance(self):
        return morphometricAnalysisMorphometric()
