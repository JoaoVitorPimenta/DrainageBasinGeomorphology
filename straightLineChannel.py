...
from .algorithms.auxiliarys.straightLineChannel import calculateSinuosityGeometry,verifyLibs

class straightChannelCalc(QgsProcessingAlgorithm):
    '''
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        straightLinesFields = QgsFields()

        straightLinesFields.append(
            QgsField(
                "basin_id",
                QVariant.Int
            )
        ...
        straightLines, path = self.parameterAsSink(
            parameters,
            self.STRAIGHT_LINES,
            context,
            straightLinesFields,
        ...
        # or output names.
        return {self.STRAIGHT_LINES: path}
    ...
    def shortHelpString(self):
        ...
        <strong>Straight lines: </strong>Layer containing the straight lines calculated from the channel network inside basin.
