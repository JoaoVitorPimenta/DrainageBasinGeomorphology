...
from .algorithms.fillDEMProcessing import calcFilledForParameter, verifyLibs

class filledCalc(QgsProcessingAlgorithm):
    '''
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        inundationRasterFolder = self.parameterAsString(parameters, self.FILLED_DEM, context)

        inundationVectorFolder = self.parameterAsString(parameters, self.MODIFIED_AREA, context)

        verifyLibs()
        calcFilledForParameter(basinSource,demLayer,selectedParameter,parameterValue,inundationRasterFolder,inundationVectorFolder,noDataValue,openRasters,openVectors,feedback)
        ...
        # or output names.
        return {self.FILLED_DEM: inundationRasterFolder,
