...
class EAVBelowCalc(QgsProcessingAlgorithm):
    ...
    def name(self):
        ...
        '''
        return 'Calculate elevation-area-volume below'
    ...
    def group(self):
        ...
        should be localised.
        '''
        return self.tr("Basin EAV curves")
    ...
    def shortHelpString(self):
        ...
        <html>
            <body>
                <p>       
        This tool calculates elevation - area - volume (below) for each basin feature individually.               
                </p>
                <p>
        ...
        <strong>Elevation area volume data: </strong>File with elevation - area - volume (below) data calculated individually for each basin.
        <strong>Graphs: </strong>Folder containing the elevation-area-volume (below) graph for each basin individually.        
